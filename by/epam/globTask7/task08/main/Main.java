...
public class Main implements Serializable{
    public static void main(String[] args) throws IOException {
        ...
        new Customer(30006745,112).addToList(customer);
        new Customer(60006745,112).addToList(customer);
        new Customer(50006745,112).addToList(customer);
        new Customer(80006745,112).addToList(customer);
        new Customer("Kostya","Kitov" ,90004322,113).addToList(customer);
