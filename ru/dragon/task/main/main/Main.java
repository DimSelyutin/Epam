...
import ru.dragon.task.main.controller.TrAllCommand;
import ru.dragon.task.main.controller.TrByCoastCommand;
import ru.dragon.task.main.controller.TrMostEspensiveCommand;
...
public class Main implements Serializable{
    public static void main(String[] args) {
        ...
        Command caveAll = new TrAllCommand(cave);
        // Command caveByCoast = new TrByCoastCommand(cvLogic);
        Command caveMostEspensive = new TrMostEspensiveCommand(cave);

        CaveController cc = new CaveController(caveAll, caveMostEspensive);

        cc.getAllTr(cave.getCave());
        cc.getMostExpensiveTr(cave.getCave());
